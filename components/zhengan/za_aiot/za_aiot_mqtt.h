/* za_aiot_mqtt.h , MQTT module in AI IoT. */
...
#ifndef ZA_AIOT_MQTT_H
#define ZA_AIOT_MQTT_H
...
typedef enum
{
    ZA_AIOT_MQTT_TYPE_NO_OPRATE = 0,        // (0)
    ZA_AIOT_MQTT_TYPE_INITED,               // Have inited, but have not connected successfully
    ZA_AIOT_MQTT_TYPE_TERMED,               // Mqtt module have be destroying
    ZA_AIOT_MQTT_TYPE_RUNNING,              // Mqtt running , have connected successfully
    ZA_AIOT_MQTT_TYPE_DISCONNECTED,         // Mqtt Disconnected, maybe need TERM and Reconnect with INIT func
    ZA_AIOT_MQTT_TYPE_END
}za_aiot_mqtt_type_t;
