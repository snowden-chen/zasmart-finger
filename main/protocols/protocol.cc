...
void Protocol::SendIotEnt(const std::string& EvtVer,const std::string& evt) {
    //std::string message = "{\"session_id\":\"" + OidVer + "\",\"type\":\"oid\",\"update\":true,\"value\":" + oid + "}";

    std::string json = "{\"session_id\":\"" + EvtVer + "\",\"type\":\"listen\",\"state\":\"detect\",\"text\":\"" + evt + "\"}";
    SendText(json);
}
